...
SELECT P_H02PPRY_3('{"CCODREQ": "000001", "CCODIGO": "000001", "CNRODNI": "72565894", "CIDPROY": "00001"}')
SELECT P_H02PPRY_3('{"CCODREQ": "000001", "CCODIGO": "000003", "CNRODNI": "72518755", "CIDPROY": "00002"}')
SELECT P_H02PPRY_3('{"CIDPROY": "00001", "CCODREQ": "000002", "CNRODNI": "47289024", "CCODIGO": "000002"}')
--SELECT * FROM H02MPRY
--SELECT * FROM H02MREQ;
select * from h02paud;
SELECT * FROM H02DPRY
...
BEGIN
   ...
   END IF;
      ...
      END IF;
   UPDATE H02PPRY SET cEstado = 'A', tModifi = NOW() WHERE cCodigo = p_cCodigo;
   RETURN '{"OK": "OK"}';
