...
SELECT P_H02DPRY('{"CESTADO": "A", "CCODIGO": "000030", "CDNINRO": "72518755", "CCODAUD": "000014"}')
...
BEGIN
   ...
   BEGIN
      ...
      -- NUEVO PUENTE DE PROYECTO
         ...
         INSERT INTO H02DPRY (cCodigo, cCodAud, cEstado, tFecRev, mObserv, cDniNro, tModifi) VALUES 
                (p_cCodigo, p_cCodAud, p_cEstado, NULL, NULL, p_cDniNro ,NOW());
      /*ELS
