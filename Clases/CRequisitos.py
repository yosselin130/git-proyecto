...
class CRequisitos:
    ...
    def __mxMostrarRequisito(self):
        lcJson = json.dumps(self.paData)
        lcSql = "SELECT a.cCodReq,a.cDescri,c.cDescri Tipo, b.cDescri Estado, a.cDniNro FROM H02MREQ a INNER JOIN V_S01TTAB b ON TRIM(b.cCodigo) = a.cEstado AND b.cCodTab = '041'  inner JOIN V_S01TTAB c ON TRIM(c.cCodigo) = a.cTipo AND c.cCodTab = '226' WHERE a.cEstado in ('A') ORDER BY  a.cCodReq LIMIT 200"
